...
- (void)_removeDestination:(id)arg1 animated:(BOOL)arg2 completion:(void(^)(BOOL finished))arg3;
- (void)_navigateToDestination:(id)arg1 animated:(BOOL)arg2 completion:(void(^)(BOOL finished))arg3;
...
- (void)_setStyle:(long long)arg1 animated:(BOOL)arg2 completion:(void(^)(BOOL finished))arg3;
- (void)_updateStyleForViewController:(id)arg1 transitionContext:(id)arg2 completion:(void(^)(void))arg3;
